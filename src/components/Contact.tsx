    ...
    <section id="contacto" ref={ref} className="relative py-20 sm:py-28 bg-gradient-to-b from-primary/[0.05] via-primary/[0.02] to-white" style={{ zIndex: 1 }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-10 max-w-4xl mx-auto">
          <form onSubmit={handleSubmit} className="contact-form bg-secondary rounded-2xl p-8 shadow-sm">
            <div className="grid sm:grid-cols-2 gap-4 mb-4">
              <div>
                <label className="block text-sm font-medium text-white mb-1.5">Nombre</label>
                <input type="text" required className="w-full px-4 py-2.5 rounded-xl border border-white/20 bg-white/10 text-white placeholder-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/50 transition-all" placeholder="Tu nombre" />
              </div>
              <div>
                <label className="block text-sm font-medium text-white mb-1.5">Empresa</label>
                <input type="text" required className="w-full px-4 py-2.5 rounded-xl border border-white/20 bg-white/10 text-white placeholder-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/50 transition-all" placeholder="Tu empresa" />
              </div>
            </div>
            <div className="mb-4">
              <label className="block text-sm font-medium text-white mb-1.5">Correo Electrónico</label>
              <input type="email" required className="w-full px-4 py-2.5 rounded-xl border border-white/20 bg-white/10 text-white placeholder-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/50 transition-all" placeholder="correo@empresa.com" />
            </div>
            <div className="mb-4">
              <label className="block text-sm font-medium text-white mb-1.5">Teléfono</label>
              <input type="tel" className="w-full px-4 py-2.5 rounded-xl border border-white/20 bg-white/10 text-white placeholder-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/50 transition-all" placeholder="+58 412 000 0000" />
            </div>
            <div className="mb-6">
              <label className="block text-sm font-medium text-white mb-1.5">Mensaje</label>
              <textarea rows={3} required className="w-full px-4 py-2.5 rounded-xl border border-white/20 bg-white/10 text-white placeholder-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/50 transition-all resize-none" placeholder="Cuéntanos sobre tu proyecto..." />
            </div>
            <button
              type="submit"
              className="w-full bg-white text-secondary font-semibold py-3 rounded-xl hover:bg-white/90 transition-all shadow-lg shadow-black/10"
            >
          ...
          <div className="contact-info flex flex-col justify-center gap-6">
            ...
            <div className="mt-4 p-5 bg-secondary/5 rounded-xl border border-secondary/10">
              <p className="text-sm font-semibold text-secondary mb-1">Demo sin compromiso</p>
