...
export default function Testimonials() {
  ...
  return (
    <section id="testimonios" ref={ref} className="relative py-20 sm:py-28 overflow-hidden bg-gradient-to-b from-white via-accent/[0.02] to-surface" style={{ zIndex: 1 }}>
        ...
        <div className="overflow-hidden">
          <div ref={trackRef} className="flex gap-6" style={{ willChange: "transform" }}>
            {testimonials.map((t) => (
              <motion.div
                key={t.name}
                className="flex-shrink-0 w-[300px] sm:w-[380px] bg-secondary rounded-2xl p-6 shadow-sm"
